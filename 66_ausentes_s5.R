...
ausentes_interv_s5_vars <- data_dictionary |>
  filter(field_name %in% c(
    ...
    'psychlops_suic_2_sessao_5', 'psychlops_suic_3_sessao_5', 'psychlops_suic_3_1_sessao_5',
    #'psychlops_q5_2_sessao_5',
    # Encerramento -----------------------------------------------------
...
ausentes_interv_s5_condicoes <- list(
  cartao_valid = cond_eq('cartao_ressarc', 'Sim'),
  psychlops_suic_1_1_sessao_5 = cond_eq('psychlops_suic_1_sessao_5', 'Sim'),
  psychlops_suic_2_sessao_5 = cond_eq('psychlops_suic_1_sessao_5', 'Sim'),
  psychlops_suic_3_sessao_5 = cond_eq('psychlops_suic_1_sessao_5', 'Sim'),
  psychlops_suic_3_1_sessao_5 = cond_in('psychlops_suic_3_sessao_5',
