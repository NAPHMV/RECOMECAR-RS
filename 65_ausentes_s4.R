...
ausentes_interv_s4_vars <- data_dictionary |>
  filter(field_name %in% c(
    ...
    # PSYCHLOPS -------------------------------------------------------
    'psychlops_q1_2_sessao_4', 'psychlops_q2_2_sessao_4', 'psychlops_q3_2_sessao_4', 
    'psychlops_q4_1_sessao_4', 'psychlops_suic_1_sessao_4', 'psychlops_suic_1_1_sessao_4', 
    'psychlops_suic_2_sessao_4', 'psychlops_suic_3_sessao_4', 'psychlops_suic_3_1_sessao_4',
    #'psychlops_q5_2_sessao_4',
    # Encerramento -----------------------------------------------------
...
ausentes_interv_s4_condicoes <- list(
  cartao_valid = cond_eq('cartao_ressarc', 'Sim'),
  psychlops_suic_1_1_sessao_4 = cond_eq('psychlops_suic_1_sessao_4', 'Sim'),
  psychlops_suic_2_sessao_4 = cond_eq('psychlops_suic_1_sessao_4', 'Sim'),
  psychlops_suic_3_sessao_4 = cond_eq('psychlops_suic_1_sessao_4', 'Sim'),
  psychlops_suic_3_1_sessao_4 = cond_in('psychlops_suic_3_sessao_4',
...
ausentes_interv_s4_escopo <- c(
  setNames(rep(list(interv_s4_realiz_ids), 
               length(ausentes_interv_s4_vars)), 
           ausentes_interv_s4_vars)
)


# checagem de sanidade
stopifnot(!any(duplicated(names(ausentes_interv_s4_escopo))))

ausentes_interv_s4_df <- checar_faltantes(
  df |>
    filter(
      redcap_event_name == "Sessao 4 (Arm 1: Participantes)" &
        record_id %in% interv_s4_realiz_ids), 
  id_col = "record_id", 
  vars = ausentes_interv_s4_vars, 
  condicoes = ausentes_interv_s4_condicoes)